...
Press Enter/Return for a new line"></textarea>
    ...
    <div class="footer">
      <button class="submit" @click="state.popup.toggle(true)"><?php echo $settings['submit_text']; ?></button>
    </div>
  </div>
  ...
  <template x-teleport="body">
    <div id="wnca-form" class="popup form" x-show="state.popup.isOpen" x-transition.out.delay.300ms.opacity.duration.300 x-transition.enter.opacity.duration.300>
      <div class="backdrop">
        <div class="popup-body" @click.away="state.popup.toggle(false)" x-show="state.popup.isOpen" x-transition.duration.300>
          <div class="popup-header">
            <div class="close dashicons dashicons-no-alt" @click="state.popup.toggle(false)"></div>
          </div>
